...
namespace LightNodeSelfHost
{
    class Program
    {
        private static readonly string _serviceName = "LightNodeSelfHost";
        private static readonly string _displayName = "LightNodeSelfHost";
        private static readonly string _description = "LightNodeSelfHost Test Application.";
